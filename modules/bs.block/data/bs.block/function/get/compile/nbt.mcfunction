...
loot replace entity @s container.0 loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",functions:[{function:"set_name",entity:"this",name:{storage:"bs:out",nbt:"block.nbt"}}]}]}]}
data modify storage bs:data block.nbt._ set from entity @s item.components.minecraft:custom_name
loot replace entity @s container.0 loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",functions:[{function:"set_name",entity:"this",name:{storage:"bs:data",nbt:"block.nbt"}}]}]}]}
