...
execute as @n[type=minecraft:interaction,tag=bs.packtest,tag=!bs.packtest.trap,distance=..2,limit=4] run function #bs.interaction:on_hover { run: "tag @s add bs.packtest.source", executor: "source" }
execute as @n[type=minecraft:interaction,tag=bs.packtest,tag=!bs.packtest.trap,distance=..2,limit=4] run function #bs.interaction:on_hover { run: "tag @s add bs.packtest.target", executor: "target" }
execute as @n[type=minecraft:interaction,tag=bs.packtest,tag=!bs.packtest.trap,distance=..2,limit=4] run function #bs.interaction:on_hover { run: "tag @s add bs.packtest.interpreted", executor: { selector: "@n[tag=bs.packtest.executor,distance=..2]", lazy: false } }
execute as @n[type=minecraft:interaction,tag=bs.packtest,tag=!bs.packtest.trap,distance=..2,limit=4] run function #bs.interaction:on_hover { run: "tag @s add bs.packtest.lazy", executor: { selector: "@n[tag=bs.packtest.executor,distance=..2]", lazy: true } }
...
execute unless entity @n[type=minecraft:interaction,tag=bs.packtest,tag=!bs.packtest.trap,tag=bs.packtest.interpreted,distance=..2] run fail "Callback should run continuously"
execute unless entity @n[type=minecraft:interaction,tag=bs.packtest,tag=!bs.packtest.trap,tag=bs.packtest.lazy,distance=..2] run fail "Callback should run continuously"
