...
execute store result storage bs:data health.transformation[-1] float 1 run scoreboard players get #m bs.ctx
execute store result storage bs:data health.transformation[0] float 1 run scoreboard players operation #h bs.ctx -= #m bs.ctx
