...
loot replace entity @s container.0 loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",functions:[{function:"set_name",entity:"this",name:{storage:"bs:ctx",nbt:"_.left",interpret:true}}]}]}]}
...
loot replace entity @s container.0 loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",functions:[{function:"set_name",entity:"this",name:{storage:"bs:ctx",nbt:"_.right",interpret:true}}]}]}]}
