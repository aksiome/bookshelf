...
execute store result storage bs:data position.transformation[0] float 1 run scoreboard players operation #x bs.ctx -= #u bs.ctx
execute store result storage bs:data position.transformation[4] float 1 run scoreboard players operation #y bs.ctx -= #v bs.ctx
execute store result storage bs:data position.transformation[8] float 1 run scoreboard players operation #z bs.ctx -= #w bs.ctx
data modify entity B5-0-0-0-2 transformation set from storage bs:data position.transformation
