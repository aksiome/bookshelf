...
loot replace entity B5-0-0-0-3 container.0 loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",functions:[{function:"set_name",entity:"this",name:{storage:"bs:data",nbt:"dump.escape"}}]}]}]}
...
$loot replace entity B5-0-0-0-3 container.0 loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",functions:[{function:"set_name",entity:"this",name:[{storage:"bs:data",nbt:"dump.char"},{storage:"bs:data",nbt:"dump.value",color:"$(string)"},{storage:"bs:data",nbt:"dump.char"}]}]}]}]}
